...
function Cross({ color }) {
    return (
      <svg viewBox="0 0 12.061 12.063" xmlns="http://www.w3.org/2000/svg" width="0.8rem" height="0.8rem">
        <g transform="translate(-1476.2 -734.99)" fill="none" stroke={color} strokeWidth="1.2" data-name="cross">
