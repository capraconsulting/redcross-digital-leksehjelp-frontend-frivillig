(function(doc, mixpanel) {
  if (!mixpanel.__SV) {
    ...
    mixpanel.init = function(b, d, g) {
      ...
      var e = mixpanel;
      'undefined' !== typeof g ? (e = mixpanel[g] = []) : (g = 'mixpanel');
      e.people = e.people || [];
    ...
    d = doc.getElementsByTagName('script')[0];
